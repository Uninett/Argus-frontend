  ...
  return (
    <div>
      ...
      <div className='container'>
        ...
        <svg id="login-logo" viewBox="0 0 74 70" fill="none" xmlns="http://www.w3.org/2000/svg">
