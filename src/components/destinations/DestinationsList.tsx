...
const DestinationsList: React.FC = () => {
    ...
    const [{configuredMedia, knownMediaTypes, destinations}, { fetchConfiguredMedia, loadDestinations, modifyDestination, createDestination, deleteDestination }] = useDestinations();
    ...
    const removeDestination = (destination: Destination, label: string) => {
        api.deleteDestination(destination.pk)
            .then(() => {
