    ...
    <div className="header">
      <Link to="/">
        <svg id="logo" width="74" height="70" viewBox="0 0 74 70" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M22.4953 47.7931L45.3656 3.0137L68.2359 47.7931H22.4953Z" strokeWidth="2.74152" />
          <path d="M2.39699 47.7931L25.6164 2.9796L48.8358 47.7931H2.39699Z" strokeWidth="2.74152" />
          <path
            id="logotext"
